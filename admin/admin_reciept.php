...
$sub_detail = mysqli_query($con,"SELECT tbl_bookslot.*,tbl_order.* from tbl_bookslot,tbl_order where tbl_bookslot.booking_id=tbl_order.booking_id and tbl_order.login_id='$id' and tbl_bookslot.booking_id='$oid'");
