...
if (isset($_SESSION['del_boy'])) {
	...
	<table class="table table-bordered table-striped table-hover">
		<h1 style="text-align: center;"> Pickup History </h1>
		<hr>
		<tr>
