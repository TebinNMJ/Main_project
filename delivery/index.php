        ...
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li class="">
                            <a href="index.php?option=pro"><i class="fa fa-edit "></i><span class="badge">Profile</span></a>
                        </li>
                        <!-- <li class="">
                            <a href="index.php?option=add"><i class="fa fa-edit "></i><span class="badge">Add Id</span></a>
                        </li> -->
                       <!--  <li class="">
                            <a href="index.php?option=vu"><i class="fa fa-edit "></i><span class="badge">View Users</span></a>
                        </li> -->
                        <li>
                            <a href="index.php?option=vb"><i class="fa fa-table "></i><span class="badge">View Pickup</span></a>
                        </li>
                        <li>
                            <a href="index.php?option=vd"><i class="fa fa-table "></i><span class="badge">View Delivery</span></a>
                        </li>
                        <li class="">
                            <a href="index.php?option=bookinghist"><i class="fa fa-edit "></i><span class="badge">Pickup  History</span></a>
                        </li>
                        <li class="">
                            <a href="index.php?option=deliveryhist"><i class="fa fa-edit "></i><span class="badge">Delivery  History</span></a>
                        </li>
            ...
            <div id="page-wrapper">
                <div id="page-inner" >
                    ...
                    <!-- /. ROW  -->
                    <img src="assets/img/gif.gif" width="20%" style="margin-left: 450px;margin-top: 110px;border-radius: 50px;opacity: 0.5      ">
